...
#install slowdns
curl -X POST "https://api.cloudflare.com/client/v4/zones/$dnszone/dns_records" -H "X-Auth-Email: monkyluffy20@gmail.com" -H "X-Auth-Key: o1lnz-cGw3mTvMc9iXWL5_pycIyQhybSoLqjkL8L" -H "Content-Type: application/json" --data '{"type":"NS","name":"'"$(echo $nsrecord)"'","content":"'"$(echo $arecord)"'","ttl":1,"priority":0,"proxied":false}' &>/dev/null
