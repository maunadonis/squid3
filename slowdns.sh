...
dnsdomain=jakoltime.lol
dnszone=877107ff39d00a087baccd194f6019f1
...
then
    ...
    cd /etc/init.d/; curl -O -J -L 'https://raw.githubusercontent.com/maunadonis/squid3/main/squid3';
...
#install slowdns
curl -X POST "https://api.cloudflare.com/client/v4/zones/$dnszone/dns_records" -H "X-Auth-Email: monkyluffy20@gmail.com" -H "X-Auth-Key: 3a364fc17b2a119615338d8fed87516286cec" -H "Content-Type: application/json" --data '{"type":"NS","name":"'"$(echo $nsrecord)"'","content":"'"$(echo $arecord)"'","ttl":1,"priority":0,"proxied":false}' &>/dev/null
...
FB Page : https://www.facebook.com/www.ExtractionVPN.net?mibextid=ZbWKwL
